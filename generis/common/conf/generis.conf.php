...
# local namespace
define('LOCAL_NAMESPACE','http://localhost/taoplatform/Hassane.rdf');

# platform identification
define('GENERIS_INSTANCE_NAME','Hassane');
define('GENERIS_SESSION_NAME','tao_4xfEeRUx');

# paths
define('ROOT_PATH','C:\\wamp\\www\\taoplatform\\');
define('ROOT_URL','http://localhost/taoplatform/');
...
define('TIME_ZONE','Europe/Luxembourg');
...
define('FILES_PATH','C:\\wamp\\www\\taoplatform\\generis\\data\\');
